...
export default async function VersionPage({
  ...
  const sourceHtml = sourceCode
    ...
    : `<pre style="padding:1.5rem;color:#555;background:#0d1117;border-radius:0.75rem">源码文件暂未找到</pre>`;
      ...
      <header className="flex-none z-20 border-b border-white/[0.06] bg-[#080808]/90 backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-[1600px] items-center justify-between px-5 py-3">
          ...
          >
            ...
            <span className="font-semibold tracking-tight">Learn Hermes Agent</span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline text-sm text-white/50">{meta.title}</span>
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          <section className="relative overflow-hidden border-b border-white/[0.06] px-8 py-12">
            ...
            <div className="relative max-w-3xl">
              ...
              <p className="text-base text-white/40 leading-relaxed">{meta.subtitle}</p>
            </div>
          </section>
          ...
          <div className="px-8 py-8 space-y-5 max-w-3xl">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5">
                ...
                <p className="font-mono text-sm leading-relaxed text-emerald-300">+ {meta.coreAddition}</p>
              </div>
              <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5">
                <div className="mb-3 flex items-center gap-2">
              ...
              {prevVersion ? (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm font-medium text-white/65 group-hover:text-white/90">{VERSION_META[prevVersion].title}</div>
                  </div>
                </Link>
              ) : <div />}
              {nextVersion ? (
                ...
                >
                  <div>
                    ...
                    <div className="text-sm font-medium text-white/65 group-hover:text-white/90">{VERSION_META[nextVersion].title}</div>
                  </div>
                  <span className="text-white/30 group-hover:text-white/60 transition-colors">→</span>
                </Link>
              ) : <div />}
